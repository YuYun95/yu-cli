...
const templates = {
  'Vue-typeScript': {
    url: 'https://github.com/YuYun95/ts-vue',
    downloadUrl: 'https://github.com:YuYun95/ts-vue#master',
    description: 'ts-vue是一个中后台前端解决方案，它基于 vue, typescript 和 element-ui实现。'
  },
  'React-typeScript': {
    url: 'https://github.com/YuYun95/Umi-hooks',
    downloadUrl: 'https://github.com:YuYun95/Umi-hooks#master',
